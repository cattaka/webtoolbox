...
export default () => {
  ...
  return <div>
    ...
    <select name={"indent"} defaultValue={state.indent} onChange={onChangeIndent}>
      ...
      <option value={"1"}>Prettify(indent = 1)</option>
      <option value={"2"}>Prettify(indent = 2)</option>
      <option value={"3"}>Prettify(indent = 3)</option>
      <option value={"4"}>Prettify(indent = 4)</option>
      <option value={"5"}>Prettify(indent = 5)</option>
      <option value={"6"}>Prettify(indent = 6)</option>
      <option value={"7"}>Prettify(indent = 7)</option>
      <option value={"8"}>Prettify(indent = 8)</option>
    </select>
    <div>
